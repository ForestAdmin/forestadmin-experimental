...
describe('IntrospectionConfig Parameter', () => {
  ...
  describe('Backward Compatibility with introspectionSampleSize', () => {
    it('should use deprecated introspectionSampleSize when provided', async () => {
      const factory = createCosmosDataSource(
        'https://test.documents.azure.com:443/',
        'test-key',
        'test-database',
    ...
    it('should prefer introspectionConfig.sampleSize over deprecated introspectionSampleSize', async () => {
      const factory = createCosmosDataSource(
        'https://test.documents.azure.com:443/',
        'test-key',
        'test-database',
        {
          introspectionSampleSize: 200, // deprecated
          introspectionConfig: {
            sampleSize: 300, // should take precedence
          },
        },
      );
      ...
      expect(Introspector.introspect).toHaveBeenCalledWith(
        ...
        'test-database',
        mockLogger,
        300, // introspectionConfig takes precedence
        undefined,
        'DESC',
      );
    });

    it('should combine deprecated introspectionSampleSize with new ordering options', async () => {
      const factory = createCosmosDataSource(
        'https://test.documents.azure.com:443/',
        'test-key',
        'test-database',
