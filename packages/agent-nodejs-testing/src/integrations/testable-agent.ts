...
export default class TestableAgent<TypingsSchema extends TSchema = TSchema> extends TestableChart {
  ...
  async stop(): Promise<void> {
    ...
    // Remove the schema file if it was generated by the agent
    // else it will be kept in the source code
    if (this.agentOptions.schemaPath && !this.agentOptions.skipSchemaUpdate) {
